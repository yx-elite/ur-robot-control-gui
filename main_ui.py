...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("#serverConfig QLineEdit {\n"
"    margin-left: 5px;\n"
"    padding: 3px\n"
"}\n"
"\n"
"#outputFrame QScrollArea {background:blue}")
        ...
        self.serverConfig_2 = QtWidgets.QFrame(self.topFrame)
        self.serverConfig_2.setMinimumSize(QtCore.QSize(337, 0))
        self.serverConfig_2.setMaximumSize(QtCore.QSize(337, 16777215))
        self.serverConfig_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.serverConfig_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.serverConfig_2.setObjectName("serverConfig_2")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout(self.serverConfig_2)
        self.horizontalLayout_4.setSpacing(12)
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.serverLabel_2 = QtWidgets.QLabel(self.serverConfig_2)
        self.serverLabel_2.setMinimumSize(QtCore.QSize(51, 0))
        self.serverLabel_2.setMaximumSize(QtCore.QSize(51, 16777215))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.serverLabel_2.setFont(font)
        self.serverLabel_2.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.serverLabel_2.setObjectName("serverLabel_2")
        self.horizontalLayout_4.addWidget(self.serverLabel_2)
        self.comboBox = QtWidgets.QComboBox(self.serverConfig_2)
        self.comboBox.setMinimumSize(QtCore.QSize(0, 28))
        self.comboBox.setMaximumSize(QtCore.QSize(16777215, 28))
        self.comboBox.setObjectName("comboBox")
        self.horizontalLayout_4.addWidget(self.comboBox)
        self.horizontalLayout.addWidget(self.serverConfig_2)
        ...
        self.motionSelect.setMinimumSize(QtCore.QSize(310, 28))
        self.motionSelect.setMaximumSize(QtCore.QSize(310, 28))
        ...
        self.motionNameInput.setMinimumSize(QtCore.QSize(310, 28))
        self.motionNameInput.setMaximumSize(QtCore.QSize(310, 28))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.saveBtn = QtWidgets.QPushButton(self.motionConfig)
        self.saveBtn.setMinimumSize(QtCore.QSize(136, 32))
        self.saveBtn.setMaximumSize(QtCore.QSize(136, 32))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.motionTable.setVerticalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.motionTable.setVerticalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.motionTable.setVerticalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.motionTable.setVerticalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.motionTable.setVerticalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.motionTable.setVerticalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.motionTable.setVerticalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        self.motionTable.setVerticalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        self.motionTable.setVerticalHeaderItem(8, item)
        item = QtWidgets.QTableWidgetItem()
        self.motionTable.setVerticalHeaderItem(9, item)
        item = QtWidgets.QTableWidgetItem()
        ...
        self.motionTable.horizontalHeader().setDefaultSectionSize(100)
        self.motionTable.horizontalHeader().setMinimumSectionSize(100)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.serverLabel_2.setText(_translate("MainWindow", "Adapter"))
        ...
        item = self.motionTable.verticalHeaderItem(0)
        item.setText(_translate("MainWindow", "1"))
        item = self.motionTable.verticalHeaderItem(1)
        item.setText(_translate("MainWindow", "2"))
        item = self.motionTable.verticalHeaderItem(2)
        item.setText(_translate("MainWindow", "3"))
        item = self.motionTable.verticalHeaderItem(3)
        item.setText(_translate("MainWindow", "4"))
        item = self.motionTable.verticalHeaderItem(4)
        item.setText(_translate("MainWindow", "5"))
        item = self.motionTable.verticalHeaderItem(5)
        item.setText(_translate("MainWindow", "6"))
        item = self.motionTable.verticalHeaderItem(6)
        item.setText(_translate("MainWindow", "7"))
        item = self.motionTable.verticalHeaderItem(7)
        item.setText(_translate("MainWindow", "8"))
        item = self.motionTable.verticalHeaderItem(8)
        item.setText(_translate("MainWindow", "9"))
        item = self.motionTable.verticalHeaderItem(9)
