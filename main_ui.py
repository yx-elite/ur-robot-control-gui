...
"#outputFrame QScrollArea {background:blue}")
        ...
        self.connectButton = QtWidgets.QPushButton(self.connectionConfig)
        self.connectButton.setMinimumSize(QtCore.QSize(136, 32))
        self.connectButton.setMaximumSize(QtCore.QSize(136, 32))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.connectButton.setFont(font)
        self.connectButton.setObjectName("connectButton")
        self.horizontalLayout_5.addWidget(self.connectButton)
        self.disconnectButton = QtWidgets.QPushButton(self.connectionConfig)
        self.disconnectButton.setMinimumSize(QtCore.QSize(136, 32))
        self.disconnectButton.setMaximumSize(QtCore.QSize(136, 32))
        font = QtGui.QFont()
        font.setPointSize(9)
